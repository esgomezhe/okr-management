...
class Project(models.Model):
    ...
    created_by = models.ForeignKey(Users, related_name='project_created', on_delete=models.CASCADE)
    members = models.ManyToManyField(Users, related_name='project_members', through='ProjectMembers', blank=True)
...
class Objective(models.Model):
    ...
    description = models.TextField(max_length=2000, blank=True)
    owner = models.ForeignKey(Users, related_name='project_objectives', on_delete=models.CASCADE)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
...
class OKR(models.Model):
    ...
    owner = models.ForeignKey(Users, related_name='project_okrs', on_delete=models.CASCADE)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
...
class Activity(models.Model):
    ...
    name = models.CharField(max_length=255)
    description = models.TextField(max_length=2000, blank=True)
    owner = models.ForeignKey(Users, related_name='project_activities', on_delete=models.CASCADE)
    start_date = models.DateField()
    end_date = models.DateField(null=True, blank=True)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
...
class Task(models.Model):
    ...
    assignee = models.ForeignKey(Users, related_name='project_tasks', on_delete=models.CASCADE, null=True)
...
class Log(models.Model):
    ...
    user = models.ForeignKey(Users, related_name='project_logs', on_delete=models.CASCADE, null=True) 
...
class Comment(models.Model):
    ...
    user = models.ForeignKey(Users, related_name='project_comments', on_delete=models.CASCADE, null=True) 
